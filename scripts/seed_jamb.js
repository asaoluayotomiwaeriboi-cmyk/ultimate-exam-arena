...
const questions = [
  { subject: 'USE OF ENGLISH', questionText: 'Which of the following is an abstract noun?', choices: JSON.stringify(['Car', 'Beauty', 'Apple', 'Chair']), answer: 'Beauty' },
  { subject: 'JAMB Mock', questionText: 'JAMB: The capital of Nigeria is?', choices: JSON.stringify(['Lagos', 'Abuja', 'Kano', 'Port Harcourt']), answer: 'Abuja' },
  { subject: 'JAMB Mock', questionText: 'JAMB: 2+2=?', choices: JSON.stringify(['3','4','5','6']), answer: '4' }
];
