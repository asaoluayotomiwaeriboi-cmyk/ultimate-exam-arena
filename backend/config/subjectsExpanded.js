...
const expandedSubjects = [
  ...
  {
    name: 'Literature in English (WAEC)',
    code: 'LIT_WAEC',
    duration: 120,
    stream: 'arts',
    examBody: 'WAEC',
  ...
  {
    name: 'Literature in English (NECO)',
    code: 'LIT_NECO',
    duration: 120,
    stream: 'arts',
    examBody: 'NECO',
